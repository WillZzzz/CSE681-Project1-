...
namespace Project2Starter
{
  class Program
  {
    static void Main(string[] args)
    {
      ...
      newerelem1.children.AddRange(new[] { "third" });
      ...
      Write("\n\n");
            ...
            db.loadFromXml("firstPersistence.xml", out receiveDB);
            ...
            newdb.loadFromXml2("secondPersistence.xml", out receiveDB2);
